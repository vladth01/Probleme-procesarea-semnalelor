...
frecventa_eșantionare = 15  # Frecvența de eșantionare sub-Nyquist
...
# Eșantionarea semnalului original cu frecvența de eșantionare sub-Nyquist
...
# Eșantionarea celor două semnale suplimentare cu aceeași frecvență de eșantionare sub-Nyquist
...
plt.plot(t_eșantionat, semnal_eșantionat, 'bo', markersize=4, label='Eșantionare sub-Nyquist')
plt.title('Eșantionare sub-Nyquist')
plt.xlabel('Timp (s)')
plt.ylabel('Amplitudine')
plt.legend()
...
plt.plot(t_eșantionat, semnal_eșantionat_1, 'go', markersize=4, label='Eșantionare sub-Nyquist')
plt.title('Eșantionare sub-Nyquist pentru semnal 1')
plt.xlabel('Timp (s)')
plt.ylabel('Amplitudine')
plt.legend()
